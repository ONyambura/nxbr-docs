...
All sitting locations are **fully interactable** through `ox_target`, giving a natural and immersive feel to roleplay environments.



#### 🛠 Features:

* ✅ **Create sittable spots** anywhere, on any prop or object
* ✅ **Real-time placement** — no server restart required
* ✅ **Built-in admin removal option** via `ox_target`
* ✅ **Persistent or temporary spots** depending on how you use it
* ✅ **Works great for events, cafes, parks, and RP hotzones**
